...
export const CATEGORY_TAXONOMY: Record<string, Record<string, string[]>> = {
  ...
  'Beauty & Personal Care': {
    'Skincare': [
      'Face Serums', 'Moisturizers & Creams', 'Eye Creams & Treatments',
    ...
    'Makeup & Cosmetics': [
      ...
      'Makeup Remover', 'Contour & Highlight',
    ],
    'Hair Care': [
      'Shampoo & Conditioner', 'Hair Masks & Treatments', 'Hair Growth & Scalp Care',
      'Hair Styling Products', 'Hair Color & Dye', 'Wigs & Extensions',
    ],
    'Hair Styling Tools': [
      'Hair Dryers', 'Flat Irons & Straighteners', 'Curling Wands & Irons',
      'Hot Brushes', 'Hair Clippers & Trimmers',
    ],
    'Fragrance': [
    ...
    'Men\'s Grooming': [
      'Shaving & Beard Care', 'Men\'s Skincare', 'Men\'s Hair Care', 'Men\'s Fragrance',
    ],
    'Oral Care': [
    ...
    'Beauty Tools & Accessories': [
      ...
      'Eyelash Curlers', 'Makeup Mirrors', 'Beauty Fridges', 'Gua Sha & Face Tools',
    ],
  },

  'Fashion': {
    'Women\'s Clothing': [
      'Tops & T-Shirts', 'Dresses', 'Trousers & Jeans', 'Skirts', 'Outerwear & Coats',
      'Loungewear & Pyjamas', 'Sets & Co-ords',
    ],
    'Men\'s Clothing': [
      'T-Shirts & Shirts', 'Trousers & Jeans', 'Hoodies & Sweatshirts',
      'Jackets & Outerwear', 'Suits & Smart Wear',
    ],
    'Activewear & Sportswear': [
      'Leggings & Tights', 'Sports Bras', 'Gym Tops', 'Shorts', 'Tracksuits',
      'Sports Socks',
    ],
    'Shoes & Footwear': [
      'Trainers & Sneakers', 'Sandals & Slides', 'Boots', 'Heels & Wedges',
      'Slippers', 'Flat Shoes',
    ],
    'Bags & Accessories': [
      'Handbags', 'Backpacks', 'Crossbody Bags', 'Wallets & Card Holders',
      'Sunglasses', 'Hats & Caps', 'Scarves & Wraps', 'Belts', 'Watches',
    ],
    'Jewellery': [
      'Necklaces', 'Earrings', 'Bracelets', 'Rings', 'Jewellery Sets', 'Anklets',
    ],
    'Shapewear & Underwear': [
      'Shapewear', 'Bras', 'Underwear & Knickers', 'Bodysuits',
    ],
    'Swimwear': [
      'Bikinis', 'One-Piece Swimsuits', 'Swim Shorts', 'Cover-Ups & Sarongs',
    ],
    'Hair Accessories': [
      'Hair Clips & Pins', 'Headbands', 'Hair Ties & Scrunchies', 'Hair Wraps',
    ],
  },

  'Health & Wellness': {
    'Vitamins & Supplements': [
      'Vitamins & Minerals', 'Collagen Supplements', 'Probiotics', 'Protein Supplements',
      'Weight Management', 'Energy & Focus', 'Sleep Aids', 'Immune Support',
    ],
    'Fitness Equipment': [
      'Resistance Bands', 'Yoga Mats', 'Dumbbells & Weights', 'Foam Rollers',
      'Jump Ropes', 'Ab Rollers', 'Pull-Up Bars', 'Balance Boards',
    ],
    'Recovery & Pain Relief': [
      'Massage Guns', 'TENS Units', 'Compression Sleeves', 'Posture Correctors',
      'Hot & Cold Therapy', 'Acupuncture Mats',
    ],
    'Health Monitors': [
    ...
    'Women\'s Health': [
      'Feminine Hygiene', 'Menstrual Cups & Discs', 'Fertility Supplements',
      'Pregnancy & Postpartum Care',
    ],
    'Mental Wellness': [
      'Meditation & Mindfulness', 'Aromatherapy & Essential Oils', 'Stress Relief',
      'Sleep Accessories',
    ],
    'Medical Supplies': [
      'First Aid Kits', 'Compression Socks', 'Wound Care', 'Mobility Aids',
    ],
  },

  'Home & Kitchen': {
    'Cookware & Bakeware': [
      'Pots & Pans', 'Baking Trays & Dishes', 'Cast Iron', 'Non-Stick Cookware',
      'Woks & Stir Fry Pans',
    ],
    'Kitchen Gadgets': [
      'Air Fryers', 'Blenders & Juicers', 'Food Processors', 'Coffee Makers',
      'Electric Kettles', 'Toasters & Grills', 'Instant Pots & Slow Cookers',
      'Kitchen Organizers', 'Cutting Boards & Knives',
    ],
    'Home Decor': [
      'Wall Art & Prints', 'Candles & Holders', 'Vases & Planters', 'LED Lights & Strip Lights',
      'Aesthetic Decor', 'Photo Frames', 'Mirrors',
    ],
    'Bedding & Bath': [
      'Bedding Sets & Duvet Covers', 'Pillows & Cushions', 'Mattress Toppers',
      'Towels', 'Bath Mats', 'Shower Curtains', 'Blackout Curtains',
    ],
    'Cleaning': [
      'Cleaning Tools', 'Cleaning Products', 'Robot & Vacuum Accessories',
      'Mops & Brooms', 'Laundry Accessories',
    ],
    'Storage & Organisation': [
      'Storage Boxes & Bins', 'Closet Organisers', 'Desk Organisers',
      'Drawer Dividers', 'Fridge Organisers', 'Shoe Racks',
    ],
    'Furniture': [
      'Chairs & Seating', 'Tables & Desks', 'Shelving & Bookcases',
      'Storage Furniture', 'Outdoor Furniture',
    ],
    'Lighting': [
      'Desk & Table Lamps', 'Floor Lamps', 'Ceiling Lights', 'Fairy & Decorative Lights',
    ],
  },

  'Food & Beverage': {
    'Snacks': [
      'Crisps & Popcorn', 'Nuts & Seeds', 'Dried Fruit', 'Protein Bars',
      'Rice Cakes & Crackers', 'Jerky & Meat Snacks',
    ],
    'Sweets & Chocolate': [
      'Chocolate Bars & Boxes', 'Gummies & Candy', 'Cookies & Biscuits',
    ],
    'Health Foods': [
      'Superfood Powders', 'Granola & Muesli', 'Organic Foods', 'Vegan Foods',
      'Keto & Low-Carb Foods', 'Protein Powders',
    ],
    'Coffee & Tea': [
      'Ground Coffee', 'Coffee Pods & Capsules', 'Instant Coffee',
      'Herbal & Wellness Tea', 'Matcha',
    ],
    'Drinks & Beverages': [
      'Protein Shakes', 'Energy Drinks', 'Electrolyte Drinks', 'Juices',
      'Sports Drinks',
    ],
    'Condiments & Sauces': [
      'Hot Sauce', 'Marinades & Rubs', 'Dressings', 'Spreads & Jams',
    ],
    'Specialty Foods': [
      'International Foods', 'Meal Kits', 'Freeze-Dried & Camping Food',
    ],
  },

  'Electronics & Tech': {
    'Phone Accessories': [
      'Phone Cases', 'Screen Protectors', 'MagSafe Accessories', 'Phone Stands & Holders',
    ],
    'Charging & Power': [
      'Chargers & Cables', 'Power Banks', 'Wireless Chargers', 'Multi-Port Chargers',
    ],
    'Audio': [
      'Earbuds & In-Ear Headphones', 'Over-Ear Headphones', 'Bluetooth Speakers',
      'Microphones', 'Soundbars',
    ],
    'Wearables': [
    ...
    'Computers & Peripherals': [
      ...
      'Webcams', 'External Drives',
    ],
    'Photography & Video': [
      'Camera Accessories', 'Tripods & Stabilizers', 'Ring Lights', 'Action Cameras',
  ...
  'Sports & Outdoors': {
    'Running & Cycling': [
      'Running Shoes', 'Cycling Accessories', 'Running Gear', 'Hydration Packs',
    ],
    'Gym & Training': [
      'Gym Wear', 'Gym Gloves & Straps', 'Gym Bags', 'Pre-Workout & Intra-Workout',
    ],
    'Yoga & Pilates': [
      'Yoga Mats', 'Yoga Blocks & Straps', 'Pilates Equipment', 'Meditation Cushions',
    ],
    'Outdoor & Camping': [
      'Camping Gear', 'Hiking Accessories', 'Tents & Sleeping Bags',
      'Outdoor Lighting', 'Survival Tools',
    ],
    'Water Sports': [
      'Swimming Accessories', 'Surfing & Paddleboarding', 'Snorkelling', 'Swim Gear',
    ],
    'Team & Racket Sports': [
      'Football Accessories', 'Tennis & Badminton', 'Basketball Gear',
    ],
    'Sports Accessories': [
      'Water Bottles & Flasks', 'Sports Bags', 'Resistance Loops', 'Jump Ropes',
    ],
  },
  ...
  'Pets': {
    'Dog': [
      ...
      'Dog Beds & Furniture', 'Dog Training', 'Dog Health & Supplements',
    ],
    'Cat': [
      'Cat Food & Treats', 'Cat Toys', 'Cat Grooming', 'Cat Beds & Furniture',
      'Litter & Litter Boxes', 'Cat Health & Supplements',
    ],
    'Pet Accessories': [
      'Leashes & Harnesses', 'Pet Carriers', 'Pet Cameras', 'Automatic Feeders',
      'Pet Strollers', 'ID Tags',
    ],
    'Small Animals & Birds': [
      'Small Animal Supplies', 'Bird Supplies', 'Aquarium & Fish Supplies',
    ],
  },

  'Kids & Baby': {
    'Baby Gear': [
      'Baby Carriers', 'Pushchairs & Prams', 'Baby Monitors', 'Car Seats',
    ...
    'Toys & Games': [
      'Educational Toys', 'Building & Construction', 'Dolls & Accessories',
      'Action Figures', 'Sensory Toys', 'Slime & Craft Kits',
      'Remote Control Vehicles', 'Board Games & Puzzles',
    ],
    'Learning & Education': [
      'Baby & Toddler Books', 'Flash Cards', 'Art & Craft Supplies',
      'Science Kits', 'Musical Instruments for Kids',
    ],
    'Kids\' Clothing': [
  ...
  'Automotive': {
    'Car Accessories': [
      'Car Phone Holders', 'Dash Cams', 'Seat Covers', 'Steering Wheel Covers',
      'Car Air Fresheners', 'Sunshades', 'Boot Organisers',
    ],
    'Car Electronics': [
    ...
    'Tools & Equipment': [
      'Tool Sets', 'Jacks & Stands', 'Air Compressors', 'OBD Scanners',
    ],
  },
  ...
  'Tools & Home Improvement': {
    ...
    'Power Tools': [
      'Drills', 'Circular Saws', 'Sanders', 'Electric Screwdrivers',
    ],
    'Home Improvement': [
      'Painting Supplies', 'Adhesives & Tapes', 'Wall Anchors & Fasteners',
      'Door & Window Hardware', 'Caulking & Sealants',
    ],
    'Safety & Security': [
      'Smoke & CO Detectors', 'Door Locks & Deadbolts', 'Safe Boxes',
      'Security Cameras', 'Door & Window Alarms',
    ],
    'Garden & Outdoor': [
...
export const ALL_CATEGORY_PATHS: string[] = Object.entries(CATEGORY_TAXONOMY).flatMap(
  ([l1, subcats]) =>
    Object.entries(subcats).flatMap(([l2, leaves]) =>
      leaves.map((l3) => `${l1} > ${l2} > ${l3}`)
    )
);
