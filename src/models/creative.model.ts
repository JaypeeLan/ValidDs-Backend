...
export const CreativeSchema = new Schema<ICreativeDocument>(
  {
    ...
    estimatedVideoGmv: { type: Number, default: null },
    estimatedVideoSales: { type: Number, default: null },
    estimatedVideoGmvShare: { type: Number, default: null, min: 0, max: 1 },
    estimatedVideoGmvMethod: {
      type: String,
      enum: ['view_share', 'sole_video', 'equal_split', 'none'],
      default: null,
    },
    estimatedVideoGmvComputedAt: { type: Date, default: null },
